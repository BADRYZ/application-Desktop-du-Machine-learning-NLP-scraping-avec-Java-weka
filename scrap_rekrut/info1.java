...
public class ch1 {
    ...
    private static JPanel createTablePanel() {
        ...
        try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/ch1?useSSL=false", "root", "");
    ...
    private static DefaultPieDataset createTeletravailDataset() {
        ...
        try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/ch1", "root", "");
             Statement statement = connection.createStatement();
